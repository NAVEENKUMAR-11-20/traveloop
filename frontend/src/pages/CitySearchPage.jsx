...
const allCities = [
  ...
  { id: 14, name: 'Pondicherry', country: 'India', continent: 'Asia', image: 'https://images.unsplash.com/photo-1589718539308-185121b81b5c?w=800&q=80', rating: 4.7, costIndex: '₹₹', description: 'French colonial charm and serene spiritual centers' },
  { id: 15, name: 'Ooty', country: 'India', continent: 'Asia', image: 'https://images.unsplash.com/photo-1590050752117-23aae2fc1101?w=800&q=80', rating: 4.6, costIndex: '₹₹', description: 'Queen of Hill Stations with misty tea gardens' },
  ...
  { id: 18, name: 'Hyderabad', country: 'India', continent: 'Asia', image: 'https://images.unsplash.com/photo-1559800611-3d98533d7d99?w=800&q=80', rating: 4.6, costIndex: '₹₹', description: 'City of Pearls and iconic Charminar' },
  ...
  { id: 21, name: 'Mysore', country: 'India', continent: 'Asia', image: 'https://images.unsplash.com/photo-1600100397561-43202166e921?w=800&q=80', rating: 4.8, costIndex: '₹₹', description: 'Royal heritage and magnificent palaces' },
  { id: 22, name: 'Agra', country: 'India', continent: 'Asia', image: 'https://images.unsplash.com/photo-1548013146-72479768bbaa?w=800&q=80', rating: 4.9, costIndex: '₹₹', description: 'Home to the eternal Taj Mahal' },
  { id: 23, name: 'Kochi', country: 'India', continent: 'Asia', image: 'https://images.unsplash.com/photo-1589985273514-67ba8f0bc004?w=800&q=80', rating: 4.6, costIndex: '₹₹', description: 'Queen of the Arabian Sea and historic spice port' },
