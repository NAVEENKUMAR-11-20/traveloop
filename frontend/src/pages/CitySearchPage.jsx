...
const allCities = [
  ...
  { id: 14, name: 'Pondicherry', country: 'India', continent: 'Asia', image: 'https://images.unsplash.com/photo-1590132840003-883ec7303e89?auto=format&fit=crop&w=800&q=80', rating: 4.7, costIndex: '₹₹', description: 'French colonial charm and serene spiritual centers' },
  { id: 15, name: 'Ooty', country: 'India', continent: 'Asia', image: 'https://images.unsplash.com/photo-1541433131875-307b3d92ff15?auto=format&fit=crop&w=800&q=80', rating: 4.6, costIndex: '₹₹', description: 'Queen of Hill Stations with misty tea gardens' },
  { id: 16, name: 'Munnar', country: 'India', continent: 'Asia', image: 'https://images.unsplash.com/photo-1593181629936-11c609b8db9b?auto=format&fit=crop&w=800&q=80', rating: 4.8, costIndex: '₹₹', description: 'Lush green tea plantations and rolling hills' },
  { id: 17, name: 'Bengaluru', country: 'India', continent: 'Asia', image: 'https://images.unsplash.com/photo-1596176530529-78163a4f7af2?auto=format&fit=crop&w=800&q=80', rating: 4.5, costIndex: '₹₹₹', description: 'The Garden City and Silicon Valley of India' },
  { id: 18, name: 'Hyderabad', country: 'India', continent: 'Asia', image: 'https://images.unsplash.com/photo-1626014303757-535133649987?auto=format&fit=crop&w=800&q=80', rating: 4.6, costIndex: '₹₹', description: 'City of Pearls and iconic Charminar' },
